...
import com.wf.core.common.utils.RedisCacheUtils;
import com.wf.core.common.utils.ServletUtils;
import com.wf.core.common.utils.StringUtils;
import com.wf.core.common.utils.ip.IpUtils;
import com.wf.core.common.utils.uuid.IdUtils;
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            try {
                ...
                LoginUser user = redisCacheUtils.getCacheObject(userKey);
                return user;
            } catch (Exception e) {
            }
        }
